...
const simplePieChart: ChartType = {
    ...
    colors: ['#34c38f', '#d4af37', '#f46a6a', '#50a5f1', '#f1b44c'],
    legend: {
        show: true,
        position: 'bottom',
...
const basicRadialBarChart: ChartType = {
    ...
    colors: ['#d4af37', '#34c38f', '#f46a6a', '#f1b44c'],
    series: [44, 55, 67, 83],
